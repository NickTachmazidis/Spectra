...
from src.data_process import smoothing, peaks_find, baseline, \
    norm_min_max, norm_z
...
class Main(QtWidgets.QMainWindow, Funcs):
    ...
    def __init__(self, settings):
        ...
        self.sep = settings.general.sep
        self.engine = settings.general.engine
        ...
        # Normalize Z
        self.button_normalize_z.clicked.connect(
            lambda: self.process_data(norm_z, None))
